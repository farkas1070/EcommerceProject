...
export default function App() {
  ...
  const [cartItem, setCartItem] = useState({
    ...
    ShoeID: shoeData.shoeID, // Replace with the actual shoe ID
  ...
  const addToCart = async () => {
    try {
      ...
      const response = await axios.post('https://localhost:7212/api/Cart/add', cartItem);
    ...
    const getShoeData = async () => {
      try {
        const response = await axios.get(
          `https://localhost:7212/api/Shoes/${shoeID}`
        );
        // Assuming your API response is in the format { data: {...} }
        setShoeData(response.data);
        setCartItem((prevCartItem) => ({
          ...prevCartItem,
          ShoeID: response.data.shoeID,
        }));
    ...
    <section className=" ">
      ...
      <div className="container mx-auto px-4 mt-10">
        ...
        <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
          ...
          <h1 className="sm: text-2xl font-custom text-gray-900 sm:text-3xl">
              {shoeData.brandName}
            </h1>
            ...
            <div className="mt-3 flex select-none flex-wrap items-center gap-1">
              <Menu>
                <MenuHandler>
                  <Button>Choose Your Size</Button>
                </MenuHandler>
                <MenuList className="max-h-72">
                  ...
                  <MenuItem>37</MenuItem>
                  <MenuItem>38</MenuItem>
                  <MenuItem>39</MenuItem>
            ...
            <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
              <div className="flex items-end">
                <h1 className="text-3xl font-bold">${shoeData.price}</h1>
              </div>
