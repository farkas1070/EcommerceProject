        ...
        <div className="lg:flex lg:items-start">
          <div className="lg:order-2 lg:ml-5">
            <div className="max-w-xl overflow-hidden rounded-lg">
              <img className="h-full w-full max-w-full object-cover" src="https://img01.ztat.net/article/spp-media-p1/4a84592e03474ab79ddeb9cf4679af38/65aae9fa85b746188ba55146ba4512da.jpg?imwidth=1800&filter=packshot" alt="" />
            </div>
          </div>
          ...
          <div className="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
            <div className="flex flex-row items-start lg:flex-col">
              <button type="button" className="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                <img className="h-full w-full object-cover" src="https://img01.ztat.net/article/spp-media-p1/4a84592e03474ab79ddeb9cf4679af38/65aae9fa85b746188ba55146ba4512da.jpg?imwidth=1800&filter=packshot" alt="" />
              </button>
