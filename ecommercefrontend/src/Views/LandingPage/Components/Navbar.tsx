...
export default function App (props: IAppProps) {
  return (
    ...
    <header className="flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 text-blue-900 md:mx-auto md:flex-row md:items-center">
    ...
    <label className="absolute top-5 right-7 cursor-pointer md:hidden text-blue-600" >
    ...
    <nav aria-label="Header Navigation" className="peer-checked:mt-8 peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full md:flex-row md:items-start">
      <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
        <li className="font-bold text-black md:mr-12"><a href="#">Register</a></li>
        <li className="text-black md:mr-12"><a href="#">Login</a></li>
        <li className="text-black md:mr-12"><a href="#">About</a></li>
