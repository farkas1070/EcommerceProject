      ...
      <div data-aos="fade-up" className="grid container  lg:grid-cols-5 md:grid-cols-3 justify-center gap-4">
          ...
          {shoes.map((shoe)=>{
            return (
              ...
              <div className="group  border-gray-100/30 flex w-full h-full max-w-xs flex-col self-center overflow-hidden rounded-lg border bg-[#0e0e0e] shadow-md">
                <a
                ...
                <div className="mt-4 px-5 pb-5 flex flex-col flex-grow justify-between">
                  <div>
                  <a href="#">
                    <h5 className="text-xl tracking-tight text-white">
                      {shoe.brandName} - {shoe.productName}
                    </h5>
                  </a>
