...
export default function Register() {
  const notify = () => toast.error('Notification Message');
  ...
  const handleRegistration = async (e: FormEvent) => {
    try {
      e.preventDefault();
      const response = await axios.post('https://localhost:7212/api/User/register', formData);
    ...
    <section className="min-h-screen flex items-stretch text-white ">
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style={{backgroundColor: "#161616"}}>
            ...
            <div className="w-full py-6 z-20">
                ...
                <form onSubmit={handleRegistration} action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                <div className="pb-2 pt-4">
                        <input onChange={handleInputChange} name="Username"  placeholder="Username" className="block w-full p-4 text-lg rounded-sm bg-black" />
                    </div>
                    <div className="pb-2 pt-4">
                        <input onChange={handleInputChange} name="email" placeholder="Email" className="block w-full p-4 text-lg rounded-sm bg-black" />
                    </div>
                    <div className="pb-2 pt-4">
                        <input onChange={handleInputChange} name="passwordHash" className="block w-full p-4 text-lg rounded-sm bg-black" placeholder="Password" />
                    </div>
